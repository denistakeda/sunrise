...
const createStringAttr = (attrName: string) => (value: Value<string>) => (element: HTMLElement) =>
  formula((value) => element.setAttribute(attrName, value), value)

const createProperty = <T extends HTMLElement, K extends keyof T>(propName: K) => (
  value: Value<T[K]>
) => (element: T) => formula((value) => (element[propName] = value), value)
...
export const classList = (classes: { [key: string]: Value<boolean> }) => (element: HTMLElement) => {
...
export const muted: (isMuted: Value<boolean>) => Property<HTMLVideoElement> = (isMuted) => (
  element
) => {
  formula((isMuted) => {
    if (isMuted) {
...
export const testId: (id: Value<string>) => Property<HTMLElement> = createStringAttr('data-testid')

export const id: (val: Value<string>) => Property<HTMLElement> = createStringAttr('id')

export const hide: (shouldBeHidden: Value<boolean>) => Property<HTMLElement> = (shouldBeHidden) => (
  element
) => {
...
export const inputType: (val: Value<string>) => Property<HTMLInputElement> = createProperty('type')

export const onSelect: (
  value: Value<((ev: Event) => any) | null>
) => Property<HTMLInputElement> = createProperty('onselect')
...
export const onClick: (fn: Value<() => void>) => Property<HTMLElement> = (fn) => (element) =>
...
export const text: (innerText: Value<string>) => Property<HTMLElement> = (innerText) => (element) =>
